...
namespace Chinook.Framework.Entities
{
    ...
    public partial class Track
    {
        ...
        [Required(ErrorMessage ="Name is a required field.")] //  This Property cant have a null value
        [StringLength(200, ErrorMessage = "Name is too long. Max length is 200 characters.")]
        public string Name { get; set; }

        [Range(1, int.MaxValue, ErrorMessage = "Album is invalid.")] // This property's value must fit in the range of min/max values
